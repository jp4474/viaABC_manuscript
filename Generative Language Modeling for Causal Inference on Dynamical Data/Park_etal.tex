...
\section*{Results}
\subsection*{VIA-ABC infers parameters from learned representations of the noisy dynamical input}
...
These studies, fix the parameters $c=d=1$  and aim to infer \( \theta = (a, b)\) from prior distributions guided by either the density of the data given $\theta$ or a distance between weighted simulated and observed data.    %\(a, b \sim \mathrm{Uniform}(0, 10)\).
